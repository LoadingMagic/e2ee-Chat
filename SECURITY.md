...
- Use Subresource Integrity (run `generate-sri.ps1` to enable).
- Implement additional code signing and verification.
...
1. **Save your recovery key.** – Write it down physically; don't store it digitally.
